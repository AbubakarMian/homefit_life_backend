...
@section('dashboard')
    ...
    <div class=" row searchTrainer">
        <form method="post" action="{{ url('user/dashboard') }}">
            ...
            <div class="col-sm-2">
                <button type="button" data-toggle="modal" data-target="#AdvanceSearchModal"
                    class="btn btn-primary btnAdvSearch"><i class="fa fa-server" aria-hidden="true"></i> Advance
                    Search</button>
            </div>
        </form>
    </div>
    ...
    <div class="row ChartsArea">
        <div class="col-sm-4">
            <div class="NutrationArea">
                ...
                <select class="form-control" name="months" id="months" onchange="nutritient_monthly(this.value);" <option
                        ...
                        <div class="tab">
                            <div class="AdvanceSearchArea">
                                ...
                                <div class="formAdvanceSearch">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="trainer_name" class="form-control valid"
                        ...
                        <div class="tab">
                            ...
                            <div class="trainerSelect">
                                <ul class="nav nav-pills">
                                    <li><a data-toggle="pill" class="btn btn-primary btnTabs" onclick="show_trainer_list();"
                                            href="#home">Rating</a></li>

                                    <li><a data-toggle="pill" class="btn btn-primary btnTabs"
                                            onclick="show_trainer_class_list();" href="#menu3">Upcomming Group Class</a>
                                    </li>
                                </ul>
                        ...
                        <div style="overflow:auto;">
                            <div style="float:right;">
                                ...
                                <button type="button" class="btn btn-primary" id="nextBtn"
                                    onclick="show_trainer_list();nextPrev(1)">Next</button>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function nutritient_monthly(month) {
            ...
            var myurl = "{!!  asset('/user/nutritiondailygoalmonthly') !!}/" + currentMonth + "?user_id=" +
                "{!!  $user->id !!}";
            $.ajax({
                url: myurl,
                method: 'get',
                ...
                success: function(data) {
                    if (data.status) {
                        ...
                        for (var i = 0; i < data.response.length; i++) {
                            var html = '';
                            var left_carbo = data.response[0]['total_carbohydrates'] - data.response[0][
                                'avg_carbohydrates'
                            ];
                            var left_fat = data.response[0]['total_fats'] - data.response[0]['avg_fats'];
                            var left_protien = data.response[0]['total_proteins'] - data.response[0][
                                'avg_proteins'
                            ];
                            html = `
                            <tr>
