                ...
                <div class="col-sm-12">
                    ...
                    <div class="InnerContent">
                        ...
                        <div class="profileVideosArea bgProfile">
                            ...
                            <ul class="list-inline">
                                @foreach($trainer_gallery as $tg)

                                @if($tg->type == 'video')
                                <li> <video width="190" height="190" controls>
                                        <source src="{{$tg->url}}" type="video/mp4">
                                        Your browser does not support the video tag.
                                    </video>
                                    @else
                                <li><img src="{{$tg->url}}" class="img-responsive"></li>
                            ...
                            <div class="GroupClassSliderArea">
                                ...
                                <div id="GroupClassSlider" class="carousel slide hidden-xs" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        @foreach($trainig_class as $key=>$tc)
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="col-item">
                                                        ...
                                                        <div class="Details">
                                                            <h5>{!! $tcs->package->name!!} </h5>
                                                            <p>{!! $tcs->package->details!!} </p>
                            ...
                            <ul class="list-inline">
                                ...
                                <li>
                                    <div class="packagePrice">
                                        <a href="{{asset('user/payment?package_id='.$p->id)}}">
                                            <h3> <span class="label label-primary">{!! $p->name!!}</span> </h3>${!! $p->price !!}
                                        </a>
                                    </div>
                                </li>
                                @endforeach
...
<script type="text/javascript">
    ...
    function c(passed_month, passed_year, calNum) {
        ...
        clickedElement.on("click", function() {
            ...
            // $("#calendreModal").modal("show");
            console.log('calender modal', $("#calenderModal"));
            // $.ajax({
            //     type: "Get",
